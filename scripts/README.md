...
| `convert_inference_json_to_arrow.py` | Convert service-shaped inference JSON into direct Rust Arrow inputs, preserving seed constraints and `altered_cluster_signatures` sidecars; optionally precomputes model-keyed altered-profile splits |
